...
**Sub-pattern: clipped result reveals and connective-free hooks.** A specific version of this tell is the pause-and-reveal opener where connective words are stripped out to make the result land harder: "I tried it. 0% AI-generated. Here's how." A person recounting the same thing usually keeps the natural connectives: "I tried it, and the results came back as 0% AI-generated. Here's how." Watch for verbless fragments carrying the payoff ("0% AI-generated." / "100% human." / "Sold out in a day."). When rewriting, restore the subject and connective unless the surrounding voice sample shows the writer genuinely talks this way. This applies to hooks and spoken scripts too; do not exempt the first line just because it is a hook.

**Before:**
> I tried it. 0% AI-generated. Here's how.

**After:**
> I tried it, and the results came back as 0% AI-generated. Here's how.
